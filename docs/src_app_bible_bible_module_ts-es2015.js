...
BibleReadIframeComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BibleReadIframeComponent, selectors: [["app-bible-read-iframe"]], decls: 4, vars: 0, consts: [[1, "embed-responsive", "embed-responsive-16by9", "card-shadow", "mb-3"], ["src", "https://download-a.akamaihd.net/files/media_publication/29/pk_TU_038_r720P.mp4", "crossorigin", "anonymous", "controls", "", 1, "embed-responsive-item"], [1, "embed-responsive", "embed-responsive-16by9", "card-shadow"], ["title", "Sample Video", "src", "https://download-a.akamaihd.net/files/media_publication/9c/pk_TU_034_r720P.mp4", "crossorigin", "anonymous", "controls", "", 1, "embed-responsive-item"]], template: function BibleReadIframeComponent_Template(rf, ctx) { if (rf & 1) {
...
const routes = [
    ...
    { path: 'video', component: _bible_read_iframe_bible_read_iframe_component__WEBPACK_IMPORTED_MODULE_2__.BibleReadIframeComponent },
